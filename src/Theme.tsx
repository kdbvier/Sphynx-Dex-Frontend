...
export const darkTheme = (() => {
  const custom = {
    ...
    communityCardBackground: '#191C41',
    currencySelectButton: '#2E2E55',
    inputPanelBorder: '#21214A',
    switchModal: '#191C41',
    invertSwitchModal: '#2A2E60',
    global: '#27262c',
    globalBorder: '',
    lineBtn: '#222341',
    inputWrapper: '#040413',
    cardWrapper: '#1A1A3A',
    contributeWrapper: '#5E2B60',
    tableSuccess: '#219653',
    tableError: '#EB5757',
    lpCard: '#040413',
    gradient: 'linear-gradient(90deg, #610D89 0%, #C42BB4 100%)',
